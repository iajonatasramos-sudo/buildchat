# 11. Guia técnico completo (documento vivo do projeto)

> **De onde veio.** Este é o `CLAUDE.md` do repositório: o guia que foi escrito e reescrito ao
> longo de todo o desenvolvimento, e que o assistente lê antes de cada mudança. É o documento
> mais detalhado que existe sobre o sistema — cada seção explica não só o que foi feito, mas
> **por que**, e o que já deu errado antes.
>
> Os documentos numerados desta pasta resumem e organizam o que está aqui. Quando a dúvida for
> específica, a resposta provavelmente está neste arquivo.
...
**produto SaaS multiempresa** — ver [12-planejamento-original.md](12-planejamento-original.md).
...
Detalhes, fases e pendências: [12-planejamento-original.md](12-planejamento-original.md).
