# 12. Planejamento do servidor (histórico)

> **De onde veio.** É o `PLANEJAMENTO-SERVIDOR.md` do repositório, escrito quando o produto
> ainda era 100% local e ia virar um SaaS. Serve como registro das fases e das decisões de
> origem. Parte já foi feita; leia como histórico, não como plano em aberto.
